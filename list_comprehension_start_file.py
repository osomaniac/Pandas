...
results = [i for i in myfile if "line3" in i]
print(results)
...
result2 = [x+y for x in [10,20,30] for y in [40,50,60]] ## nested loop, going through outter loop(x) and then the inner loop(y)
print(result2)
...
vehicle_list = [v.upper() for v in vehicles if vehicles[v] < 5000]
print(vehicle_list)